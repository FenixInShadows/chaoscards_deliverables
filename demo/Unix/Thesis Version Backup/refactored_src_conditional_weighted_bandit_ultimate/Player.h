...
public:
	...
	Player(const std::string& _name, int _hp, const std::vector<Card*>& _deck, bool _is_guest, std::queue<DeferredEvent*>& _event_queue, CardEncoderNet* _encoder = nullptr);
	Player(const std::string& _name, int _hp, const std::vector<Card*>& _deck, bool _is_guest, std::queue<DeferredEvent*>& _event_queue, int _ai_level, CardEncoderNet* _encoder = nullptr);
	Player(const std::string& _name, int _hp, const std::vector<Card*>& _deck, bool _is_guest, std::queue<DeferredEvent*>& _event_queue, int _ai_level, const std::vector<Card*>& _card_pool, CardEncoderNet* _encoder = nullptr);
	~Player();
...
Card* CreateCardFromLatentCode(const std::string& name, const torch::Tensor& code, CardEncoderNet* encoder);
Card* GenerateSampledCard(const std::string& name, CardEncoderNet* encoder);
std::vector<Card*> GenerateSampledCardSet(int n, CardEncoderNet* encoder); // uses "Anonymous" as the names
Card* CreateCardFromLatentCodeWithCost(const std::string& name, const torch::Tensor& code, int cost, CardEncoderNet* encoder);
Card* GenerateSampledCardWithCost(const std::string& name, int cost, CardEncoderNet* encoder);
Card* CreateMinionFromLatentCodeWithCost(const std::string& name, const torch::Tensor& code, int cost, CardEncoderNet* encoder);
Card* GenerateSampledMinionWithCost(const std::string& name, int cost, CardEncoderNet* encoder);
