...
int main(int argc, char* argv[]) // argument order, if supplied: mode, seed, file paths (with different semantics among modes)
{
	...
	cout << "8 : Test a card set in terms of balance (Warning: this may take hours to days)." << endl;
	cout << "9 : Produce an html file for a given card set." << endl;
	...
	case 9:
		{
			...
			{
				cout << "Input card data file path (no space): " << endl;
				cin >> Card_Path;
			}
			...
			{
				cout << "Output html file path (no space): " << endl;
				cin >> Html_Script_Path;
			}
